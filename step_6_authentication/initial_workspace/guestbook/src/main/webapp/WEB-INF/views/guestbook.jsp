			...
			<div class="navbar-collapse collapse">
				<div class="nav navbar-nav navbar-right">
					<div class="navbar-form">
						<!-- 
							TODO: Add support for showing only 'sign in' or 'sign out' option based
							depending if user is authenticated or not.
						-->
						<a href="TODO: Add support for sign out" class="btn btn-primary"><span class="glyphicon glyphicon-log-out"></span> Sign Out</a>
						<a href="TODO: Add support for sign in" class="btn btn-primary"><span class="glyphicon glyphicon-log-in"></span> Sign In</a> 
					</div>
				</div>
			</div>
			<!--/.navbar-collapse -->
		...
		<div class="panel panel-primary" style="margin-top: 50px;">
			...
			<div class="panel-body">
				...
				<form:form name="addCommentForm" role="form" method="post" id="addCommentForm"
					...
					<!-- TODO: IMAGES CAN BE POSTED ONLY BY AUTHENTICATED USER-->
					...
					<div class="form-group">
						...
						<!-- 
							TODO: When user is logged in use his account to resolve nickname
							and disable possibility of manual setup for nickname.
						 -->

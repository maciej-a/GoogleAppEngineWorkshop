...
<%--
TODO: Uncomment this javascript
It removes image if it's empty to avoid
problems with BLOB upload on GAE server.
...
<body>
	...
	<div class="container">
		...
		<div class="panel panel-primary" style="margin-top: 50px;">
			...
			<div class="panel-body">
				<!-- TODO: get BlobstoreService from BlobstoreServiceFactory here -->
				
				<%-- TODO: Change action so that it points to Blobstore upload URL
					 action='<%= blobstoreService.createUploadUrl("/addComment") %>'
				 --%>
				<form:form name="registerForm" role="form" method="post"
					commandName="newComment" action="/addComment">
